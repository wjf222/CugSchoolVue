  ...
  <div class="me-view-comment-item">
    <div class="me-view-comment-author">
      ...
      <div class="me-view-info">
        ssd
        <span class="me-view-nickname">{{comment.commentatorName}}</span>
    ...
    <div>
      <p class="me-view-comment-content">{{comment.commentContent}}</p>
  ...
  export default {
    ...
    methods: {
      ...
      publishComment() {
        ...
        this.publishComment(that.reply).then(data => {
